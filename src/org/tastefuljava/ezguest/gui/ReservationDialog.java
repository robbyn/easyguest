...
public class ReservationDialog extends javax.swing.JDialog {
    ...
    private void initOtherDataComponents(Date fromDate, Date toDate,
            Room room) {
        if (fromDate != null) {
    ...
    public void save() throws InputException {
        ...
        try {
            ...
            int num = (Integer)roomNumber.getSelectedItem();
    ...
    private void initComponents() {
        ...
        jLabel4.setText(bundle.getString("reservation.room")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("reservation.date-min-max")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jLabel3.setText(bundle.getString("reservation.status")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        statusReserved.setSelected(true);
        statusReserved.setText(bundle.getString("reservation.status.reserved")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 5);
        ...
        statusOccupied.setText(bundle.getString("reservation.status.occupied")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 11);
        ...
        statusReleased.setText(bundle.getString("reservation.status.released")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        statusCanceled.setText(bundle.getString("reservation.status.canceled")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jLabel14.setText(bundle.getString("reservation.search-label")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        search.setText(bundle.getString("invoice.search-client")); // NOI18N
