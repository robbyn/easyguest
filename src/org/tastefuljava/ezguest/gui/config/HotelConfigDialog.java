...
public class HotelConfigDialog extends javax.swing.JDialog {
    private static final Log LOG = LogFactory.getLog(HotelConfigDialog.class);
    ...
    private void initialize(JFrame parent) throws HeadlessException {
    ...
    private void initOtherDataComponents() {
    ...
    private void fileChooserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooserActionPerformed
        try {
            ...
            LOG.error(Util.getResource("error.hotel.unknown"),e);
