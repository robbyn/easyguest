...
public class InvoicePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchById.setText(bundle.getString("invoice.search.byid")); // NOI18N
        ...
        searchByCustomer.setText(bundle.getString("invoice.search.bycustomer")); // NOI18N
        ...
        searchByDate.setText(bundle.getString("invoice.search.bydate")); // NOI18N
        ...
        search.setText(bundle.getString("invoice.search")); // NOI18N
        ...
        jLabel20.setText(bundle.getString("invoice.search.room-number")); // NOI18N
        ...
        jLabel2.setText(bundle.getString("invoice.search.name")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel3.setText(bundle.getString("invoice.search.company")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        jLabel4.setText(bundle.getString("invoice.search.dateminmax")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 11);
        ...
        jLabel1.setText(bundle.getString("invoice.search.id")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 12, 0, 11);
        ...
        print.setText(bundle.getString("invoice.print")); // NOI18N
        ...
        preview.setText(bundle.getString("invoice.preview")); // NOI18N
        ...
        jLabel16.setText(bundle.getString("invoice.id")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel17.setText(bundle.getString("invoice.date-created")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jLabel19.setText(bundle.getString("invoice.status")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 5);
        ...
        statusOpen.setText(bundle.getString("invoice.status.open")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 5);
        ...
        statusPayed.setText(bundle.getString("invoice.status.payed")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 0, 11);
        ...
        existingCustomer.setText(bundle.getString("invoice.existing-customer")); // NOI18N
        ...
        newCustomer.setSelected(true);
        newCustomer.setText(bundle.getString("invoice.new-customer")); // NOI18N
        ...
        jLabel18.setText(bundle.getString("invoice.search-label")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 5);
        ...
        searchCustomer.setText(bundle.getString("invoice.search")); // NOI18N
        ...
        modify.setText(bundle.getString("invoice.modify-client")); // NOI18N
        ...
        jLabel5.setText(bundle.getString("invoice.title")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel6.setText(bundle.getString("invoice.firstname-lastname")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel8.setText(bundle.getString("invoice.company")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel9.setText(bundle.getString("invoice.address")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel10.setText(bundle.getString("invoice.zip-city")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel11.setText(bundle.getString("invoice.state-country")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel12.setText(bundle.getString("invoice.phone-mobile")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        jLabel13.setText(bundle.getString("invoice.fax-email")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jTabbedPane1.addTab(bundle.getString("invoice.tab.general"), jPanel2); // NOI18N
        ...
        jLabel7.setText(bundle.getString("invoice.reservations")); // NOI18N
        ...
        addReservation.setText(bundle.getString("invoice.reservation.add")); // NOI18N
        ...
        deleteReservation.setText(bundle.getString("invoice.reservation.delete")); // NOI18N
        ...
        jLabel15.setText(bundle.getString("invoice.articles")); // NOI18N
        ...
        addArticle.setText(bundle.getString("invoice.article.add")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 0);
        ...
        deleteArticle.setText(bundle.getString("invoice.article.delete")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 11, 0);
        ...
        jTabbedPane1.addTab(bundle.getString("invoice.tab.content"), panelDetails); // NOI18N
