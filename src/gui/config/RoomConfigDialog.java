...
public class RoomConfigDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(java.util.ResourceBundle.getBundle("resources").getString("room.dialog.title"));
        ...
        nameLabel.setText(java.util.ResourceBundle.getBundle("resources").getString("roomtypes.dialog.roomtype.name"));
        ...
        priceLabel.setText(java.util.ResourceBundle.getBundle("resources").getString("roomtypes.dialog.roomtype.price"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        descriptionLabel.setText(java.util.ResourceBundle.getBundle("resources").getString("roomtypes.dialog.roomtype.description"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        newTypeButton.setText(java.util.ResourceBundle.getBundle("resources").getString("roomtypes.dialog.types.button.new"));
        ...
        delRoomTypeButton.setText(java.util.ResourceBundle.getBundle("resources").getString("roomtypes.dialog.types.button.delete"));
        ...
        typesroomsTabbedPane.addTab(java.util.ResourceBundle.getBundle("resources").getString("room.dialog.tab.types"), roomTypesPanel);
        ...
        numberLabel.setText(java.util.ResourceBundle.getBundle("resources").getString("rooms.dialog.room.number"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 0, 11);
        ...
        typeLabel.setText(java.util.ResourceBundle.getBundle("resources").getString("rooms.dialog.room.type"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 12, 11, 11);
        ...
        newRoomButton.setText(java.util.ResourceBundle.getBundle("resources").getString("rooms.dialog.rooms.button.new"));
        ...
        delRoomButton.setText(java.util.ResourceBundle.getBundle("resources").getString("rooms.dialog.rooms.button.delete"));
        ...
        typesroomsTabbedPane.addTab(java.util.ResourceBundle.getBundle("resources").getString("room.dialog.tab.rooms"), roomsPanel);
